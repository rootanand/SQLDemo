...
namespace ado_sql_Demo2
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            // sqlconn.ConnectionString = "SERVER=DECOY-PC\\SQLEXPRESS; Database=Student; uid=root;pwd=data";
            //sqlconn.ConnectionString = "SERVER=DECOY-PC\\SQLEXPRESS; Database=Student; trusted_connection=true";
            ...
            sqlconn.ConnectionString = "SERVER=DECOY-PC\\SQLEXPRESS; Database=Student; Integrated security=SSPI";
...
//insert using nonquery
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            // sqlconn.ConnectionString = "SERVER=.\\SQLEXPRESS; Database=Student; Integrated Security=true";
            //sqlconn.ConnectionString = "SERVER=.\\SQLEXPRESS; Database=Student; Trusted_connection=true";
            sqlconn.ConnectionString = "SERVER=.\\SQLEXPRESS; Database=Student; Integrated Security=SSPI";
            try
            {
                sqlconn.Open();
            }
